...
class JMagickEngineEnginesRepositoryTests extends GroovyTestCase {
    ...
    @Override
    void setUp() {
        engine = enginesRepository.get(JMagickEngine)
        assertTrue(engine instanceof JMagickEngine)
    }
    ...
    public void scaleAccurateJPG_paramsProvided_shouldExecuteAction() {
        ...
        writeImage(result, 'jmagick_scaleAccurateJPG_height_bigger.jpg')
        ...
        assertEquals(100, result.width)
        assertEquals(100, result.height)
        writeImage(result, 'jmagick_scaleAccurateJPG_image.jpg')
        ...
        assertEquals(100, result.width)
        assertEquals(100, result.height)
        writeImage(result, 'jmagick_scaleAccurateJPG_image2.jpg')
    }
    ...
    public void scaleAccurateBMP_paramsProvided_shouldExecuteAction() {
        ...
        assertEquals(100, result.width)
        assertEquals(100, result.height)
        writeImage(result, 'jmagick_scaleAccurateBMP_image2.bmp')
        ...
        assertEquals(100, result.width)
        assertEquals(100, result.height)
        writeImage(result, 'jmagick_scaleAccurateBMP_image.bmp')
    }
    ...
    public void scaleAccurateGIF_paramsProvided_shouldExecuteAction() {
        ...
        assertEquals(100, result.width)
        assertEquals(100, result.height)
        writeImage(result, 'jmagick_scaleAccurateGIF_image.gif')
    }
    ...
    public void scaleAccuratePNG_paramsProvided_shouldExecuteAction() {
        ...
        assertEquals(100, result.width)
        assertEquals(100, result.height)
        writeImage(result, 'jmagick_scaleAccuratePNG_image.png')
    }
    ...
    public void scaleApproximateJPG_paramsProvided_shouldExecuteAction() {
        ...
        writeImage(result, 'jmagick_scaleApproximateJPG_height_bigger.jpg')
        ...
        assertNotNull(result)
        assertEquals(100, result.width)
        assertEquals(63, result.height)
        writeImage(result, 'jmagick_scaleApproximateJPG_image.jpg')
        ...
        assertEquals(100, result.width)
        assertEquals(63, result.height)
        writeImage(result, 'jmagick_scaleApproximateJPG_image2.jpg')
    }
    ...
    public void scaleApproximateBMP_paramsProvided_shouldExecuteAction() {
        ...
        writeImage(result, 'jmagick_scaleApproximateBMP_image.bmp')
    }
    ...
    public void scaleApproximateGIF_paramsProvided_shouldExecuteAction() {
        ...
        writeImage(result, 'jmagick_scaleApproximateGIF_image.gif')
    }
    ...
    public void scaleApproximatePNG_paramsProvided_shouldExecuteAction() {
        ...
        assertEquals(100, result.width)
        assertEquals(63, result.height)
        writeImage(result, 'jmagick_scaleApproximatePNG_image.png')
    }
    ...
    public void textBMP_paramsProvided_shouldExecuteAction() {
        ...
        assertNotNull(result)
        writeImage(result, 'jmagick_textBMP_image.bmp')
    }
    ...
    public void textGIF_paramsProvided_shouldExecuteAction() {
        ...
        assertNotNull(result)
        writeImage(result, 'jmagick_textGIF_image.gif')
    }
    ...
    public void textPNG_paramsProvided_shouldExecuteAction() {
        ...
        assertNotNull(result)
        writeImage(result, 'jmagick_textPNG_image.png')
    }
    ...
    public void watermarkJPG_paramsProvided_shouldExecuteAction() {
        ...
        assertNotNull(result)
        writeImage(result, 'jmagick_watermarkJPG_height_bigger.jpg')
        ...
        assertNotNull(result)
        writeImage(result, 'jmagick_watermarkJPG_image.jpg')
        ...
        assertNotNull(result)
        writeImage(result, 'jmagick_watermarkJPG_image2.jpg')
    }
    ...
    public void watermarkBMP_paramsProvided_shouldExecuteAction() {
        ...
        assertNotNull(result)
        writeImage(result, 'jmagick_watermarkBMP_image.bmp')
    }
    ...
    public void watermarkGIF_paramsProvided_shouldExecuteAction() {
        ...
        assertNotNull(result)
        writeImage(result, 'jmagick_watermarkGIF_image.gif')
    }
    ...
    public void watermarkPNG_paramsProvided_shouldExecuteAction() {
        ...
        assertNotNull(result)
        writeImage(result, 'jmagick_watermarkPNG_image.png')
    }
